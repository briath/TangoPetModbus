...
#
INC_DIR_USER= -I . -I/usr/include/modbus
...
#
LIB_DIR_USER= -L/usr/lib/x86_64-linux-gnu
...
ADDITIONAL_OBJS = \
		$(OBJDIR)/ImplLibModbus.o \
		$(OBJDIR)/PetException.o
...
$(OBJDIR)/ImplLibModbus.o:  ImplLibModbus.cpp $(SVC_INCL)
	$(CXX) $(CXXFLAGS) -c $< -o $(OBJDIR)/ImplLibModbus.o
$(OBJDIR)/PetException.o:  PetException.cpp $(SVC_INCL)
	$(CXX) $(CXXFLAGS) -c $< -o $(OBJDIR)/PetException.o
